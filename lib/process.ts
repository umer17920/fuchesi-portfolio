...
export const process: Stage[] = [
  {
    ...
    body: 'We start with your process rather than our proposal: what the business does, where it breaks, and what the breakage costs you. This is also where we tell you if you do not need us. A cheaper answer that works is a better answer, and saying so early is the point of discovery.',
  ...
  },
  {
    ...
    body: 'Migration, testing, and rollout are planned as part of the work rather than bolted on at the end. Where it makes sense we go live in stages, so the business is never betting everything on a single day.',
  ...
  },
  {
    ...
    body: 'Software that is used gets changed. We fix what breaks, extend what works, and stay reachable. Nobody is handed a repository and wished luck. You own the code and infrastructure throughout, so staying with us is a choice rather than a trap.',
